...
app = Flask(__name__)
app.config['SQLALCHEMY_DATABASE_URI'] = 'mysql+mysqlconnector://u27qbimmucpd4iqv:NlTpk4KkjSfpQDsslO87@bwjfhl1bryhhz1i70gou-mysql.services.clever-cloud.com:3306/bwjfhl1bryhhz1i70gou'
